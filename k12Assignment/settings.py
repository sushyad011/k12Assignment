"""
Django settings for k12Assignment project.
...
SECRET_KEY = '^h9%jrnrt2)v&f)mu#394y04ny=b@7&o9#fe&xgll)jn39hcfe'
...
ROOT_URLCONF = 'k12Assignment.urls'
...
WSGI_APPLICATION = 'k12Assignment.wsgi.application'
